        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'Admin login success') {
              (0, _alert.showAlert)('success', 'Admin Login Successfully.');
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"productcrud.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Inserted Successfully.');
              window.setTimeout(function () {
                location.assign('/crud');
              }, 1500);
            }
...
var _productcrud = require("./productcrud");
...
if (productDataForm) {
  productDataForm.addEventListener('submit', function (e) {
    ...
    (0, _productcrud.insertProduct)(form, 'data');
  });
}
