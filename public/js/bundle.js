...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, password, passwordConfirm, phoneNumber, email, pincode, city, state, flat, locality, landmark) {
    var res;
...
exports.remove = exports.increment = exports.decrement = exports.addToCart = void 0;
...
var addToCart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productId, size) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Added to cart Successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var decrement = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(productId, size) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Decrement');
            }
  ...
  return function decrement(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var increment = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(productId, size) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Increment');
            }
  ...
  return function increment(_x5, _x6) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Remove');
            }
...
var card = document.querySelectorAll('.display-card');
var trashBtn = document.querySelectorAll('.trash'); //Values
//Delegation

if (signupForm) {
  signupForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var name, password, passwordConfirm, phoneNumber, email, pincode, city, state, flat, locality, landmark;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _signup.signup)(name, password, passwordConfirm, phoneNumber, email, pincode, city, state, flat, locality, landmark);
...
if (addtocartBtn) addtocartBtn.addEventListener('click', function (e) {
  ...
  if (!size) {
    ...
    (0, _addToCart.addToCart)(productId, size);
...
var _loop = function _loop(i) {
  decrementBtn[i].addEventListener('click', function (e) {
    ...
    if (document.getElementById("".concat(productId, "-").concat(productSize)).value == 1) {
      card[i].innerHTML = ''; //removeitem(cardno);
    }
...
var _loop2 = function _loop2(_i2) {
  trashBtn[_i2].addEventListener('click', function (e) {
